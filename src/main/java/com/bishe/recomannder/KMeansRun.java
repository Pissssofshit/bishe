...
//            float[] list = {1,2,3,4};
            float[] list = Arrays.copyOfRange(original_data.get(i),1,original_data.get(i).length);
//            System.arraycopy(original_data.get(i),1,list,0,original_data.get(i).length-1);
            pointList.add(new Point((int)original_data.get(i)[0], list));
        }
    }
